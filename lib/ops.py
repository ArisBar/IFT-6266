...
def deconv(X, w, ratio=2):
    """
    upsampling function
    """
    upsamp_X = T.nnet.abstract_conv.bilinear_upsampling(X, ratio=ratio, use_1D_kernel=False)
    return T.nnet.conv2d(upsamp_X, w, border_mode='half')

...
class Adam_clip(Update):

    def __init__(self, lr=0.001, b1=0.9, b2=0.999, e=1e-8, l=1-1e-8, clip_val=0.01, *args, **kwargs):
        Update.__init__(self, *args, **kwargs)
        self.__dict__.update(locals())
    ...
    def __call__(self, params, cost):
        ...
        for p, g in zip(params, grads):
            ...
            p_t = T.clip(p_t, -1.0*self.clip_val, 1.0*self.clip_val)
